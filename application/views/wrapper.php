...
<head>
    ...
    <meta name="description" content="Solo Clean">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-ERC51TXCVG"></script>
    <script>
    ...
    <script>
        ...
        fbq('init', '1022646591789729');
        fbq('track', 'PageView');
    </script>
    <noscript>
        <img height="1" width="1" src="https://www.facebook.com/tr?id=1022646591789729&ev=PageView&noscript=1" />
    </noscript>
...
<body>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="hero-animation-img pt-lg-4">
                            ...
                            <img class="img-fluid d-none d-lg-block animation-three" src="<?= base_url() ?>includes/frontend/img/product-img-1.png" alt="animation image" width="280">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <?php foreach ($produk as $prod) { ?>
                            <div class="item">
                                <div class="single-product rounded shadow-sm white-bg">
                                    <img src="<?= base_url() ?><?= $prod['produk_image'] ?>" class="img-fluid p-4" alt="product" />
                                    <div class="product-info text-center pb-4 px-3">
                                        <h4 class="mb-1"><?= $prod['nama_produk'] ?></h4>
                                        <a target="_blank" href="<?= $prod['link_produk'] ?>" class="btn secondary-btn"><span class="ti-shopping-cart"></span> Buy Now</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
        ...
        <section class="download-section ptb-100 background-img" style="background: url('<?= base_url() ?>includes/frontend/img/kv-background-marketplace.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-md-7">
                        <form action="#" method="POST" id="contactForm1" class="contact-us-form" novalidate="novalidate">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" name="phone" value="" class="form-control" id="phone" placeholder="Nomor Telefon">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" name="company" value="" size="40" class="form-control" id="company" placeholder="Perusahaan Anda">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea name="message" id="message" class="form-control" rows="7" cols="25" placeholder="Pesan"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="footer-nav-wrap text-white">
                            ...
                            <div class="social-list-wrap">
                                <ul class="social-list list-inline list-unstyled">
                                    <li class="list-inline-item"><a href="https://www.instagram.com/solocleanid/" target="_blank" title="Instagram"><span class="ti-instagram"></span></a>
                                    </li>
                                    <li class="list-inline-item"><a href="https://www.facebook.com/profile.php?id=100069411781346" target="_blank" title="Facebook"><span class="ti-facebook"></span></a></li>

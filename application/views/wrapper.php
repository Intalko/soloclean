...
<head>
    ...
    <!--Magnific popup css-->
    <link rel="stylesheet" href="<?=base_url()?>includes/frontend/css/magnific-popup.css">
    <!--Themify icon css-->
    <link rel="stylesheet" href="<?=base_url()?>includes/frontend/css/themify-icons.css">
    <!--flaticon css-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>includes/frontend/fonts/flaticon.css">
    <!--animated css-->
    <link rel="stylesheet" href="<?=base_url()?>includes/frontend/css/animate.min.css">
    <!--ytplayer css-->
    <link rel="stylesheet" href="<?=base_url()?>includes/frontend/css/jquery.mb.YTPlayer.min.css">
    <!--Owl carousel css-->
    <link rel="stylesheet" href="<?=base_url()?>includes/frontend/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?=base_url()?>includes/frontend/css/owl.theme.default.min.css">
    <!--custom css-->
...
<header class="header">
    ...
    <nav id="nav" class="navbar navbar-expand-lg fixed-top custom-nav white-bg">
        <div class="container">
            <a class="navbar-brand" href="<?=base_url()?>index-3.html"><img src="<?=base_url()?>includes/frontend/img/logo-color.png" width="120" alt="logo" class="img-fluid"></a>
...
<div class="main">
    ...
    <section class="hero-section hero-section-3 ptb-100">
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="hero-animation-img pt-lg-4">
                        <img class="img-fluid d-block m-auto animation-one" src="<?=base_url()?>includes/frontend/img/model-run.png" alt="animation image">
                        <img class="img-fluid d-none d-lg-block animation-three"
                             src="<?=base_url()?>includes/frontend/img/product-img-1.png" alt="animation image" width="280">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--shape image start-->
        <img src="<?=base_url()?>includes/frontend/img/hero-bg-shape-2.svg" class="shape-image" alt="shape image">
        <!--shape image end-->
    </section>
    <!--hero section end-->
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="about-content-left">
                        <div class="section-heading">
                            <h2>Go for a <span>Run...</span> and leave your phone at home.</h2>
                            <p class="mb-4">Quick has all the right tools in order to make your website building process
                        ...
                        <ul class="list-unstyled">
                            <li class="py-2">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <div class="badge badge-custom-secondary mr-3">
                ...
                <div class="col-md-6">
                    <div class="about-content-right d-flex justify-content-center justify-content-lg-end justify-content-md-end">
                        <img src="<?=base_url()?>includes/frontend/img/watch-5.png" alt="about us" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="specs" class="technical-space ptb-100">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4">
                    <div class="img-wrap">
                        <img src="<?=base_url()?>includes/frontend/img/single-watch.png" alt="watch" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="section-heading">
                        ...
                        <p class="lead">
                            ...
                            transition wireless customer service without goal.
                        </p>
                    </div>
                    <div class="row justify-content-between">
                        <div class="col-md-5">
                            <div class="tech-feature-single mt-5">
                                <div class="tech-feature-title">
                                    <span class="color-secondary ti-camera icon-md d-block mb-3"></span>
                                    <h5 class="mb-2">Camera Available</h5>
                                </div>
                                <p>Uniquely seize team building expertise and future-proof process improvements.</p>
                            </div>
                            <div class="tech-feature-single mt-5">
                                <div class="tech-feature-title">
                                    <span class="color-secondary ti-settings icon-md d-block mb-3"></span>
                                    <h5 class="mb-2">Readable in Sunlight</h5>
                                </div>
                                <p>Monotonectally coordinate proactive quality vectors rather than high-payoff
                                    processes. </p>
                            </div>
                            <div class="tech-feature-single mt-5">
                                <div class="tech-feature-title">
                                    <span class="color-secondary ti-video-camera icon-md d-block mb-3"></span>
                                    <h5 class="mb-2">Advance Video</h5>
                                </div>
                                <p>Interactively negotiate synergistic innovation before global materials
                                    sustainable</p>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="tech-feature-single mt-5">
                                <div class="tech-feature-title">
                                    <span class="color-secondary ti-thought icon-md d-block mb-3"></span>
                                    <h5 class="mb-2">Eco Friendly</h5>
                                </div>
                                <p>Intrinsicly network long-term high-impact intellectual capital before user
                                    friendly.</p>
                            </div>
                            <div class="tech-feature-single mt-5">
                                <div class="tech-feature-title">
                                    <span class="color-secondary ti-server icon-md d-block mb-3"></span>
                                    <h5 class="mb-2">30 Days Battery Time</h5>
                                </div>
                                <p>Energistically fabricate extensible web-readiness rather than vertical ideas
                                    visualize. </p>
                            </div>
                            <div class="tech-feature-single mt-5">
                                <div class="tech-feature-title">
                                    <span class="color-secondary ti-rss-alt icon-md d-block mb-3"></span>
                                    <h5 class="mb-2">Wifi Enable</h5>
                                </div>
                                <p>Continually engineer extensible deliverables rather than efficient
                                    potentialities.</p>
                            </div>
                        </div>
                    </div>
    ...
    <!--faq section start-->
    <section id="faq" class="faq-section ptb-100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-heading text-center mb-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="single-faq py-3 px-3">
                        <h5><span>Q. </span> How can I pay for this?</h5>
                ...
                <div class="col-md-6">
                    <div class="single-faq py-3 px-3">
                        <h5><span>Q. </span> Is it possible to pay yearly?</h5>
                        <p>Assertively iterate user friendly innovation without open-source markets. Monotonectally extend
                            resource sucking manufactured products without high-payoff paradigms.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="single-faq py-3 px-3">
                        <h5><span>Q. </span>Do you offer discounts on multiple items?</h5>
                        <p>Dramatically target focused testing procedures after holistic ideas. Collaboratively maximize
                            high-payoff ROI and value-added products. Distinctively deliver cooperative.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="single-faq py-3 px-3">
                        <h5><span>Q. </span> Is VAT included in plan prices?</h5>
                        <p>Distinctively simplify high-quality initiatives for highly efficient applications. Monotonectally
                            repurpose integrated customer service after magnetic e-services intrinsicly implement high standards. </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="single-faq py-3 px-3">
                        <h5><span>Q. </span> Will I pay more for some features?</h5>
                        <p>Enthusiastically pontificate resource-leveling supply chains whereas scalable markets.
                            Authoritatively streamline resource maximizing.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="single-faq py-3 px-3">
                        <h5><span>Q. </span> Why are there no limits on the number?</h5>
...
<!--jQuery-->
<script src="<?=base_url()?>includes/frontend/js/jquery-3.4.1.min.js"></script>
<!--Popper js-->
...
<!--Magnific popup js-->
<script src="<?=base_url()?>includes/frontend/js/jquery.magnific-popup.min.js"></script>
<!--jquery easing js-->
<script src="<?=base_url()?>includes/frontend/js/jquery.easing.min.js"></script>
<!--jquery ytplayer js-->
<script src="<?=base_url()?>includes/frontend/js/jquery.mb.YTPlayer.min.js"></script>
<!--wow js-->

...
<html lang="en">
	<head>
		...
		<title>Liez Florist - Toko bunga, krans bunga dan buket bunga purwokerto purbalingga, banjarnegara, banyumas, cilacap dan kebumen @ Liez Florist - <?=$title?></title>

		<meta name="keywords" content="<?=$meta['keywords']?>">
		<meta name="description" content="<?=$meta['description']?>">
		<meta name="author" content="<?=$meta['author']?>">
		
		<meta property="og:url"           content="http://liezfloristdecor.com" />
		<meta property="og:type"          content="website" />
		<meta property="og:title"         content="Liez Florist - Toko bunga, krans bunga dan buket bunga purwokerto purbalingga, banjarnegara, banyumas, cilacap dan kebumen @ Liez Florist" />
		<meta property="og:description"   content="<?=$meta['description']?>" />
		<meta property="og:image"         content="<?=base_url()?>/includes/frontend/img/slide/slide1-h1.jpg" />
		...
		<link rel="stylesheet" href="<?=base_url()?>includes/frontend/vendor/datepicker/datepicker3.css">
		<link rel="stylesheet" href="<?=base_url()?>includes/frontend/vendor/timepicker/bootstrap-timepicker.css">
	...
	<?php $sess_u = $this->session->userdata('user');?>
									...
									<div class="topheader-navholder-rg">
										...
										<nav id="main-nav">
											<ul class="nav navbar-nav megamenu">
												...
												<li class="dropdown">
													<a href='<?=base_url()?>carapesan'>Cara Pesan</a>
												</li>
						...
						<div class="row">
							<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-sp-12">
								...
								<div class="social_block">
									<ul class="links">
										<li><a href="https://www.facebook.com/liezfloristpurwokerto"><em class="fa fa-facebook"></em><span class="unvisible">facebook</span> </a></li>
										<li><a href="https://twitter.com/liezflorist_id"><em class="fa fa-twitter"></em><span class="unvisible">twitter</span> </a></li>
										<li class="last"><a href="https://www.instagram.com/liezfloristdecor/"><em class="fa fa-instagram"></em><span class="unvisible">instagram</span> </a></li>
									</ul>
							...
							<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 col-sp-12">
								<div class="block-html block">
									...
									<div class="block_content">
										...
										<p>Pada hari besar nasional kami tidak melayani</p>
									</div>
		...
		<!-- Template Custom -->
		<script src="<?=base_url()?>includes/frontend/vendor/datepicker/bootstrap-datepicker.js"></script>
		<script src="<?=base_url()?>includes/frontend/vendor/timepicker/bootstrap-timepicker.js"></script>
		<script type="text/javascript">$('#dp3').datepicker();</script>
		<script type="text/javascript">$('#tp3').timepicker({
                template: false,
                showInputs: false,
                minuteStep: 5
        });</script>

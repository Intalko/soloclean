			...
			<div class="tabs-top block">
				<div class="block-title">
					...
					<ul id="myTabs" class="nav nav-tabs" role="tablist">
						<?php foreach($kategori as $key => $ktgri) {?>
							<li role="presentation" class="<?php if($ktgri['id']==1){?>active<?php } ?>"><a href="#<?= $ktgri['id_nama']?>" aria-controls="<?= $ktgri['id_nama']?>" role="tab" data-toggle="tab"><?= $ktgri['nama_kategori']?></a></li>
						<?php } ?>
					</ul>
				</div><!--end title -->
				...
				<div class="tab-content">
					<?php foreach($kategori as $key2 => $ktgri2) { ?>
						<div role="tabpanel" class="tab-pane <?php if($ktgri2['id']==1) {?>active<?php } ?>" id="<?= $ktgri2['id_nama']?>">
							<div class="block_content">
								<div class="row">
									...
									<?php }else{ ?>
										...
										Belum ada Produk di Kategori ini, stay tune yah.
										</h2>
									<?php } ?>
								</div><!-- end row -->
